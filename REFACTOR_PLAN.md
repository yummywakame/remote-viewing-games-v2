...
| 11 | Game flow | Move `QUESTION_VARIANTS` defaults to BaseGame | `BaseGame.js`, `ColorGame.js` | [x] | [x] | [x] | BaseGame already accepts `questionVariants` prop; add defaults there |
